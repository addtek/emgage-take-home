 ...
 */
export class RoleListComponent extends React.Component<IRoleListProp, IRoleListState> {
  ...
  */
  ...
  onApplyFilter(clear?: boolean) {
    ...
    this.loadRoleDefs(this.roleDefSearchQueryBuilder());
    this.setState(prev => ({
      dropdownEle: { ...prev.dropdownEle, ['filter']: null },
    }));
  }
   ...
   */
  render(): JSX.Element {
    const { actionInProgress, showModal, bulkAction, dropdownEle, filterConfig, hideRow, loadingRole } = this.state;
    const {
      roleDefs,
      theme,
    } = this.props;
        ...
        <Column medium="3-4">
          <div className={theme.pageContainer}>
            <Heading element="h2" theme={CommonStyle}>Roles
              ...
              >
                <Label componentId="addnewrole">Add New Role</Label>
              </Button>
            </Heading>
            ...
            >
              <div>
                ...
                >
                  <Label componentId="apply">Apply</Label>
                </Button>
               <AlertDialog
                showModal={showModal}
                titleText="Warning"
                content={(<Column large="4-6">
                <FlexBox direction="Row" justify="Center">
                <Column large="4-6"><Label componentId="modalMessage">Are You sure you want to delete this Role Definiton?</Label></Column>
                </FlexBox>
                </Column>)}
                onCancel={this.closeModal}
                onOkay={this.deleteOrPublishRoleDef}
               />
              </div>
  ...
  private bulkOptions = () => {
    ...
    return [
      {
        content: <Label componentId="status">Status</Label>,
      },
      {
        divider: true,
        content: (
      ...
      {
        content: <Label componentId="roletype">Role Type</Label>,
      },
      {
        divider: true,
        content: (
          ...
          >
            ...
            <Column small="2-4"><div className={theme.commonLeftMargin}>
                <Checkbox label={'Internal, External or Anonymous'} checked={showInternalExternalAnonymous} onChange={(val: boolean) => this.onFilterRoleDefs(val, 'showInternalExternalAnonymous')} />
            </div></Column>
          </FlexBox>
            <FlexBox
              direction="Row"
          ...
          >
            <Column small="2-4"><div className={theme.commonLeftMargin}>
              <Button
                ...
                disabled={loadingRole}
              >
                <Label componentId="clear">Clear</Label>
              </Button>
            </div></Column>
            <Column small="2-4"><div className={theme.commonLeftMargin}>
              <Button
